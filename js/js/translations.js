...
I18n.translations["de"] = {
  ...
  try_again: "Nächster Versuch!",
  board_size: "Spielfeldgröße",
  game_type: "Spielart",
  misere: "Misère",
  computer_first: "Computer beginnt",
  sounds: "Soundeffekte",
...
function initTranslations() {
  ...
  document.getElementById("computer_first_lbl").innerHTML = I18n.t("computer_first");
